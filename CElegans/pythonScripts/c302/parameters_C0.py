...
class ParameterisedModel(ParameterisedModel_C):
    ...
    def set_default_bioparameters(self):
        ...
        self.add_bioparameter("neuron_k_slow_cond_density", "0.3 mS_per_cm2", "BlindGuess", "0.1")
        
        
        self.add_bioparameter("muscle_ca_simple_cond_density", "1.2 mS_per_cm2", "BlindGuess", "0.1")
        self.add_bioparameter("neuron_ca_simple_cond_density", "0.2 mS_per_cm2", "BlindGuess", "0.1")
        ...
        self.add_bioparameter("neuron_to_neuron_exc_syn_conductance", "0.1 nS", "BlindGuess", "0.1")
        ...
        self.add_bioparameter("exc_syn_vth", "-10 mV", "BlindGuess", "0.1")
        self.add_bioparameter("exc_syn_erev", "0 mV", "BlindGuess", "0.1")
        self.add_bioparameter("exc_syn_k", "0.5per_ms", "BlindGuess", "0.1")

        self.add_bioparameter("neuron_to_neuron_inh_syn_conductance", "0.3 nS", "BlindGuess", "0.1")
        ...
        self.add_bioparameter("inh_syn_vth", "-10 mV", "BlindGuess", "0.1")
        self.add_bioparameter("inh_syn_erev", "-80 mV", "BlindGuess", "0.1")
        self.add_bioparameter("inh_syn_k", "0.5per_ms", "BlindGuess", "0.1")
        

        self.add_bioparameter("neuron_to_neuron_elec_syn_gbase", "0.0000 nS", "BlindGuess", "0.1")
        self.add_bioparameter("neuron_to_muscle_elec_syn_gbase", "0.0000 nS", "BlindGuess", "0.1")
