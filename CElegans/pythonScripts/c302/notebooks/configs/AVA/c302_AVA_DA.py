...
def setup(parameter_set,
    ...
    cells = list(['AVAL', 'AVAR'] + DA_motors)
    ...
    reference = "c302_%s_AVA_DA" % parameter_set
    ...
    if generate:
        ...
        c302.add_new_input(nml_doc, "AVAL", "50ms", "%sms"%end, "10pA", params)
        c302.add_new_input(nml_doc, "AVAR", "50ms", "%sms"%end, "10pA", params)
