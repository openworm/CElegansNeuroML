...
def setup(parameter_set, 
    ...
    reference = "c302_%s_TapWithdrawalWithoutMotor"%parameter_set
    ...
    if generate:
        ...
        #c302.add_new_input(nml_doc, "PLML", "1500ms", "400ms", stim_amplitude, params)
        #c302.add_new_input(nml_doc, "PLMR", "1500ms", "400ms", stim_amplitude, params)
        #c302.add_new_input(nml_doc, "AVM", "1500ms", "400ms", stim_amplitude, params)
...
if __name__ == '__main__':
    ...
    parameter_set = sys.argv[1] if len(sys.argv)==2 else 'C2WithoutMotor'
