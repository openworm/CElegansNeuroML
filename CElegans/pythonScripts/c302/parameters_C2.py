...
class ParameterisedModel(ParameterisedModel_C):
    ...
    def set_default_bioparameters(self):
        ...
        self.add_bioparameter("neuron_k_slow_cond_density", "0.45833751019872582 mS_per_cm2", "BlindGuess", "0.2")
        ...
        self.add_bioparameter("neuron_k_fast_cond_density", "0.042711643917483308 mS_per_cm2", "BlindGuess", "0.2")
        ...
        self.add_bioparameter("neuron_ca_boyle_cond_density", "1.812775772264702 mS_per_cm2", "BlindGuess", "0.2")
        ...
        self.add_bioparameter("neuron_to_muscle_exc_syn_conductance", "0.49 nS", "BlindGuess", "0.1")
        ...
        self.add_bioparameter("neuron_to_neuron_elec_syn_gbase", "0.01252 nS", "BlindGuess", "0.2")
        self.add_bioparameter("neuron_to_muscle_elec_syn_gbase", "0.51052 nS", "BlindGuess", "0.1")
