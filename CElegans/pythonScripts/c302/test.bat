REM   (Re)generate NeuroML 2 & LEMS files from the python scripts
...
REM Validate generated NeuroML 2
...
REM Try running these in jNeuroML with no GUI

REM jnml LEMS_c302_A.xml -nogui    #  Takes 2 mins to run!

jnml LEMS_c302_A_Pharyngeal.xml -nogui
jnml LEMS_c302_A_Syns.xml -nogui

 
REM Try regenerating using command line options
...
REM Try converting it to NEURON
