...
class ParameterisedModel(c302ModelPrototype):
    ...
    def set_default_bioparameters(self):
        ...
        self.add_bioparameter("exc_syn_conductance", "0.033335 nS", "BlindGuess", "0.1")
        ...
        self.add_bioparameter("inh_syn_conductance", "0.049593 nS", "BlindGuess", "0.1")
        ...
        self.add_bioparameter("elec_syn_gbase", "0.001287 nS", "BlindGuess", "0.1")

        self.add_bioparameter("unphysiological_offset_current", "5.104080 pA", "KnownError", "0")
