...
'''
        ...
        # Line, plotting: AIZL/0/GenericCell/v
        self.display_neurons.addexpr("a_AIZL[0].soma.v(0.5)", "a_AIZL[0].soma.v(0.5)", 1, 1, 0.8, 0.9, 2)
        # Line, plotting: ASHL/0/GenericCell/v
        self.display_neurons.addexpr("a_ASHL[0].soma.v(0.5)", "a_ASHL[0].soma.v(0.5)", 2, 1, 0.8, 0.9, 2)
        # Line, plotting: SMDDR/0/GenericCell/v
        self.display_neurons.addexpr("a_SMDDR[0].soma.v(0.5)", "a_SMDDR[0].soma.v(0.5)", 3, 1, 0.8, 0.9, 2)
        # Line, plotting: URYDL/0/GenericCell/v
        self.display_neurons.addexpr("a_URYDL[0].soma.v(0.5)", "a_URYDL[0].soma.v(0.5)", 4, 1, 0.8, 0.9, 2)
        # Line, plotting: VB11/0/GenericCell/v
        self.display_neurons.addexpr("a_VB11[0].soma.v(0.5)", "a_VB11[0].soma.v(0.5)", 5, 1, 0.8, 0.9, 2)
        # Line, plotting: VD12/0/GenericCell/v
        self.display_neurons.addexpr("a_VD12[0].soma.v(0.5)", "a_VD12[0].soma.v(0.5)", 6, 1, 0.8, 0.9, 2)
        ...
        # Line, plotting: AIZL/0/GenericCell/caConc
        self.display_activity_neurons.addexpr("a_AIZL[0].soma.cai(0.5)", "a_AIZL[0].soma.cai(0.5)", 1, 1, 0.8, 0.9, 2)
        # Line, plotting: ASHL/0/GenericCell/caConc
        self.display_activity_neurons.addexpr("a_ASHL[0].soma.cai(0.5)", "a_ASHL[0].soma.cai(0.5)", 2, 1, 0.8, 0.9, 2)
        # Line, plotting: SMDDR/0/GenericCell/caConc
        self.display_activity_neurons.addexpr("a_SMDDR[0].soma.cai(0.5)", "a_SMDDR[0].soma.cai(0.5)", 3, 1, 0.8, 0.9, 2)
        # Line, plotting: URYDL/0/GenericCell/caConc
        self.display_activity_neurons.addexpr("a_URYDL[0].soma.cai(0.5)", "a_URYDL[0].soma.cai(0.5)", 4, 1, 0.8, 0.9, 2)
        # Line, plotting: VB11/0/GenericCell/caConc
        self.display_activity_neurons.addexpr("a_VB11[0].soma.cai(0.5)", "a_VB11[0].soma.cai(0.5)", 5, 1, 0.8, 0.9, 2)
        # Line, plotting: VD12/0/GenericCell/caConc
        self.display_activity_neurons.addexpr("a_VD12[0].soma.cai(0.5)", "a_VD12[0].soma.cai(0.5)", 6, 1, 0.8, 0.9, 2)
