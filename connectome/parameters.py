...
chem_exc_syn_gbase =            BioParameter("chem_exc_syn_gbase", "1nS", "BlindGuess", "0.1")
chem_exc_syn_erev =            BioParameter("chem_exc_syn_erev", "0mV", "BlindGuess", "0.1")
chem_exc_syn_rise =            BioParameter("chem_exc_syn_rise", "10ms", "BlindGuess", "0.1")
...
chem_inh_syn_rise =            BioParameter("chem_inh_syn_rise", "10ms", "BlindGuess", "0.1")
